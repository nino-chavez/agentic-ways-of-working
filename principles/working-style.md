...
Public snapshot, not the owner. The live operator preferences are `~/.dotfiles/ways-of-working/working-style.md` (private, 885 lines as of 2026-09-02); this file is the portable subset, last synced from it on 2026-09-01. Edit there and regenerate here; do not edit this file directly. Tool-specific wrappers live alongside (`../adapters/`) and point at whichever copy the machine has.
